--GXO Share of Transactions: GXO_trans_cnt/trans_cnt(app_buyer_l2_v.prd_health_mon_com_trans -> app_buyer_t.prd_health_mon_com_trans) (SUM(CASE WHEN EBAY_GUEST_TRANS='Y' THEN trans_cnt ELSE 0 END) AS GXO_trans_cnt)
